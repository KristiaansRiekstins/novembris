...
<head>
    ...
    <title>MineCurse- Videogallery</title>
...
<section class="container-fluid">
    <section class="row">
        <div class="col-md-2 col-sm-6 article" style="background-color:#FFFFFF">
            ...
            <div class="reklama">
                <a href="https://www.w3schools.com">
                    <img alt="Reklāma" height="100%" width="100%" src="https://s3images.coroflot.com/user_files/individual_files/155052_hmaaqivfvifqacyawanhebkka.jpg">
                </a>
            </div>
        </div>
        ...
        <div class="col-md-2 col-sm-6 article" style="background-color:#FFFFFF">
            ...
            <div class="reklama">
                <a href="https://www.w3schools.com">
                    <img alt="Reklāma" height="100%" width="100%" src="https://www.vaultnetworks.com/wp-content/uploads/2012/08/PROMO-BLOG-AD-PURPLE-VERTICAL.jpg">
                </a>
            </div>
        </div>
    </section>
