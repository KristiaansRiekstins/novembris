        ...
        <div class="col-md-8 col-sm-6 article" style="background-color:#FFFFFF">
            ...
            <form action="register.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" placeholder="parole123" id="pwd" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Parolei jāsatur vizmaz 1 ciparu, 1 lielo burtu, vienu mazo burtu un tai jābūt, kā minimums 8 simbolu garai">
                </div>
                <div class="form-group">
                    <label for="pwd">Atkārtota parole:</label>
                    <input type="password" class="form-control" placeholder="Atkārtojiet savu paroli" id="pwd" name="password2" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Parolei jāsatur vizmaz 1 ciparu, 1 lielo burtu, vienu mazo burtu un tai jābūt, kā minimums 8 simbolu garai">
                </div>
                <button type="submit" name="save" class="btn btn-success">Reģistrēties</button>
            </form>
        </div>
        <div class="col-md-2 col-sm-6 article" style="background-color:#FFFFFF">
...
<?php
    if(isset($_POST['save'])){
        ...
        echo "<b>Jūsu atkārtotā parole: </b>{$_POST['password2']}<br/>";
    }
?>
</body>
</html>
