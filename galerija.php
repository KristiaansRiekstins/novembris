...
<section class="container-fluid">
    <section class="row">
        <div class="col-md-2 col-sm-6 article" style="background-color:#FFFFFF">
            ...
            <div class="reklama">
                <a href="https://www.w3schools.com">
                    <img alt="Reklāma" height="100%" width="100%" src="https://i.pinimg.com/originals/f3/68/f7/f368f71100700310b9efd1d75bdc83b5.jpg">
                </a>
            </div>
        </div>
        ...
        <div class="col-md-2 col-sm-6 article" style="background-color:#FFFFFF">
            ...
            <div class="reklama">
                <a href="https://www.w3schools.com">
                    <img alt="reklāma" height="100%" width="100%" src="https://www.walkmytown.com/public/web-assets/images/spansors/long.jpg">
                </a>
            </div>
        </div>
    </section>
